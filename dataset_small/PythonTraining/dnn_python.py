...
if __name__ == "__main__":
    dct = unpickle("pickle_files/16_8pickle/mfcc14_RIGHT")
    ...
    model.save("model/16_8/DNN/MFCC14_RIGHT")
    ...
    plot_confusion_matrix(cm = confusion_matrix,labels_name=labels_name,title="16_8-DNN(R),acc is {}"
     .format(round(acc,2)), figname="16_8DNN_R")
